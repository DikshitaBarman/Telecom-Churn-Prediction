...
author: Snehal Agrawal, Huong Huynh, Dikshita Barman, Zhu Wen, Saurav Gupta
...
```{r}
telecom <- read.csv("C:/Users/Dikshita Barman/Downloads/telecom_churn.csv")
...
#"1" represents "Yes", "2" represents "No"
ggplot(telecom, aes(Churn)) + geom_bar(aes(fill = ContractRenewal))+ labs(title = "Contract vs Churn", subtitle = "From Customer Churn dataset", x = "Customer Churn", y = "Count")
ggplot(telecom, aes(Churn)) + geom_bar(aes(fill = DataPlan))+labs(title = "Data Plan vs Churn", subtitle = "From Customer Churn dataset", x = "Customer Churn", y = "Count")
```

We can see that the the count of customers who churned did not mostly renew their contract but the active data plan amount is high among people who churned. Here, "1" represents "Yes" and "2" represents "No".
